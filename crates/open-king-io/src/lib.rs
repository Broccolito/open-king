...
//! relatedness kernels in `open-king-core` consume.
//!
//! These type definitions are the contract between `open-king-io`, `open-king-core` and
//! `open-king-cli`. Implementations live in the submodules.
...
/// [`open_king_core::counts`](../open_king_core/counts/index.html).
///
