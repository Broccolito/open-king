...
use open_king_core::ibdseg::Called;
use open_king_core::infer::{pedigree_kinship, KinshipCache, Pedigree};
...
/// [`open_king_core::ibdseg::Scan`] returns them; `pos` is the autosomal position array the
