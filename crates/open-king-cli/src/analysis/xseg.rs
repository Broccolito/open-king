...
//!   [`open_king_core::ibdseg::usable_segments`] applies to the autosomes: at least five
...
//! printed-columns recombination [`open_king_core::ibdseg::seg_prop_ibd`] that
...
use open_king_io::{Genotypes, Sample};
