...
| `--autoQC` | Call-rate + sex QC pipeline | `<p>_autoQC_Summary.txt`, `<p>_autoQC_snptoberemoved.txt`, `<p>_autoQC_sampletoberemoved.txt`, `<p>_autoQC_updatesex.txt` | All four column layouts undocumented |
